...
The graph currently tracks **54 nodes** across 8 types and **295 weighted edges** representing causal connections.
...
- **Institutions** (10): European Central Bank (ECB), FII (Foreign Institutional Investor) Flows — India, Federal Reserve, Hezbollah, Houthis (Yemen), Iran Nuclear Program & HEU Custody Architecture, Islamic Revolutionary Guard Corps (IRGC), Marine War Risk Insurance, OPEC+, Reserve Bank of India
- **Indices** (5): INR/USD Exchange Rate, KOSPI (Korea Composite Stock Index), Nifty 50, S&P 500, US 10-Year Treasury Yield
